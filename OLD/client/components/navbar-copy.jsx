...
export default class NavBarCopy extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      keyword: '',
  ...
  //         <img
  //           className="home-icon"
  //           src="https://i.imgur.com/9HTrfXp.png"
  //           title="Click here to go to the home page of Food Wizard!" />
  //       </a>
  //     </div>
  //     <div className="tbd">
...
NavBarCopy.contextType = AppContext;
